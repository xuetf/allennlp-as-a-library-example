...
# export PYTHONPATH=./
# python3 -m pytest tests/pos_tagger/dataset_readers/conll2000_dataset_reader_test.py
class TestConll2000Reader():


    # test four experiment
    ...
    def test_read_from_file(self, lazy, coding_scheme):
        ...
        instances = conll_reader.read('tests/pos_tagger/fixtures/conll2000.txt')
